...
void TMVARegressionAngles( TString myMethodList = "" ) 
{
   ...
   TString outfileName( "TMVARegAngles.root" );
   ...
   TMVA::Factory *factory = new TMVA::Factory( "TMVARegressionAngles", outputFile, 
   ...
   // We are testing the importance of the Fox Wolfram variables, by removing them and adding
   ...
   // We are testing the importance of the Angular Quantities
   /*
